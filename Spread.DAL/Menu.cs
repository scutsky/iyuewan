...
namespace Spread.DAL
{
    ...
    public class Menu
    {
        ...
        {
            return DbHelper.GetMaxID(FieldName, "[Menu]");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 Title from [Menu]");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [Menu] set " + strField);
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
        ...
        public Spread.Model.Menu GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,MenuID,Title,ParentId,ClassList,ClassLayer,ClassOrder,IsShow,IsLock,IsMenu from [Menu] ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
            parameters[0].Value = Id;

            Spread.Model.Menu model = new Spread.Model.Menu();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,MenuID,Title,ParentId,ClassList,ClassLayer,ClassOrder,IsShow,IsLock,IsMenu from [Menu]");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 ClassList,ClassLayer from [Menu]");
            strSql.Append(" where Id=" + classId + " ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,MenuID,Title,ParentId,ClassList,ClassLayer,ClassOrder,IsShow,IsLock,IsMenu ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            try
            {
                ...
                strSql.Append(" Id,MenuID,Title,ParentId,ClassList,ClassLayer,ClassOrder,IsShow,IsLock,IsMenu ");
                strSql.Append(" FROM [Menu] ");
                if (strWhere.Trim() != "")
                {
                    strSql.Append(" where " + strWhere);
        ...
        {
            string strsql = "select max(ClassOrder)  from [Menu] where ParentId= " + ParentID.ToString() + "";
