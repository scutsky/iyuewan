...
namespace Spread.DAL
{
    public class ReportTempMain
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from ReportTempMain");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.ReportTempMain model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ReportTempMain(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.ReportTempMain model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ReportTempMain set ");
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ReportTempMain ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Num ");
            strSql.Append(" FROM ReportTempMain ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ReportTempMain T ");
