...
{
    public class DirectoryGoods
    {
        public DirectoryGoods()
		{}
		#region  成员方法
        /// <summary>
		/// 是否存在该记录
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DirectoryGoods");
        ...
        public int GetCount(string strWhere)
        {
            ...
            strSql.Append(" from DirectoryGoods ");
            if (strWhere.Trim() != "")
            {
		...
		/// 增加一条数据
		/// </summary>
		public void Add(Spread.Model.DirectoryGoods model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DirectoryGoods(");
            strSql.Append("Title,Form,ClassId,ImgUrl,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,Zhaiyao,GType,GFactory,GBrand,Code1,Code2,LanguageType)");
            ...
            parameters[17].Value = model.LanguageType;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update DirectoryGoods set " + strValue);
            strSql.Append(" where Id=" + Id);
		...
		/// 更新一条数据
		/// </summary>
		public void Update(Spread.Model.DirectoryGoods model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DirectoryGoods set ");
		...
		/// 更新内容
		/// </summary>
        public void UpdateContent(Spread.Model.DirectoryGoods model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update DirectoryGoods set ");
		...
		public void Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DirectoryGoods ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Spread.Model.DirectoryGoods GetModel(int Id)
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 Id,Title,Form,ClassId,ImgUrl,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,Zhaiyao,GType,GFactory,GBrand,Code1,Code2,LanguageType from DirectoryGoods ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;

			Spread.Model.DirectoryGoods model=new Spread.Model.DirectoryGoods();
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public Spread.Model.DirectoryGoods GetUpDownModel(int Id, bool UpOrDown)
		{
			StringBuilder strSql=new StringBuilder();
            if (UpOrDown)
            {
                strSql.Append("select top 1 * from [DirectoryGoods] WHERE Id > @Id order by Id asc ");
            }
            else { strSql.Append("select * from [DirectoryGoods] WHERE Id < @Id order by Id desc "); }
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;
        ...
        public DataSet GetList(int classId, int kindId, int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,Title,Form,Zhaiyao,ClassId,ImgUrl,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,GType,GFactory,GBrand,Code1,Code2,LanguageType ");
            strSql.Append(" FROM DirectoryGoods");
        ...
        public DataSet GetPageList(int pageSize, int currentPage, string strWhere, string filedOrder)
        {
            ...
            if (currentPage > 0)
            {
                ...
                strSql.Append("select top " + pageSize + " Id,Title,Form,Zhaiyao,ClassId,ImgUrl,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,GType,GFactory,GBrand,Code1,Code2,LanguageType from DirectoryGoods");
                strSql.Append(" where Id not in(select top " + topNum + " Id from DirectoryGoods");
                if (strWhere.Trim() != "")
                {
                    strSql.Append(" where " + strWhere);
                }
