...
namespace Spread.Web.Tools
{
    public class Advert_js : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //取得该广告位详细信息
            Spread.Model.Advertising aModel = abll.GetModel(aid);

            //输出该广告位下的广告条,不显示未开始、过期、暂停广告
            Spread.BLL.Adbanner bbll = new Spread.BLL.Adbanner();
            DataSet ds = bbll.GetList("IsLock=0 and Aid=" + aid);
