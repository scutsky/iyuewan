...
{
    public partial class Changealipayinfo : System.Web.UI.Page
    {
        private string uid = "";
        private string pwd = "";
        ...
        protected void submitbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                string myScript = @"alertMsg('手机验证码不能为空!','error.gif');";
            ...
            //{
            //    string myScript = @"alertMsg('手机验证码不正确!','error.gif');";
            //    Page.ClientScript.RegisterStartupScript(this.GetType(), "MyScript", myScript, true);
            //    return;
            //}
            if (bll.UpdatePayinfo(Request.Cookies["UserPage_UID"].Value.ToString(), this.cardnumber.Value, this.bankname.Value))
            {
