...
/**
 * Appends a <link css> or <style type="text/css"> element to the document.
 ...
 *		Array with many CSS file URLs or the CSS definitions for the <style type="text/css">
 *		element.
 * @return {Array} An array containing all elements created in the target
 *		document. It may include <link> or <style type="text/css"> elements, depending on the
