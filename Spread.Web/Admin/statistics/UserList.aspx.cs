...
{
    public partial class UserList : Spread.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect("UserList.aspx?" + this.CombUrlTxt(this.UserType, txtKeywords.Text.Trim(), this.property) + "page=0");
        }
        //删除
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            JscriptPrint("批量删除成功啦！", "UserList.aspx?" + CombUrlTxt(this.UserType, this.keywords, this.property) + "page=0", "Success");
        }
