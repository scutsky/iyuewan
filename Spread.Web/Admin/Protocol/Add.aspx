<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Spread.Web.Admin.Protocol.Add" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx?classId=<%=classId%>">返回列表</a></span><b>您当前的位置：首页 &gt; 协议管理 &gt; 发布协议</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">发布协议</th>
        </tr>
        <tr>
            <td width="15%" align="right">协议标题：</td>
            <td width="85%">
            <asp:TextBox ID="txtTitle" runat="server" CssClass="input w380 required" 
            maxlength="250" minlength="3" HintTitle="发布的协议标题" HintInfo="控制在100个字数内，标题文本尽量不要太长。"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            maxlength="10" HintTitle="协议的浏览次数" HintInfo="纯数字，本协议被阅读的次数。">0</asp:TextBox>
            </td>
        </tr>
    </table>
