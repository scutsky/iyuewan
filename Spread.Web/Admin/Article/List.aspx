<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.Article.List" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation"><span class="add"><a href="Add.aspx">发布公告</a></span><b>您当前的位置：首页 &gt; 公告管理 &gt; 公告列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><%# new Spread.BLL.Article_type().GetChannelTitle(Convert.ToInt32(Eval("ClassId")))%></td>
