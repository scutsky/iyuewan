<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddArticle_type.aspx.cs" Inherits="Spread.Web.Admin.Article.AddArticle_type" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="list.aspx?kindId=<%=kindId %>">返回列表</a></span><b>您当前的位置：首页 &gt; 公告分类管理 &gt; 增加公告分类</b>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
     ...
     <%--  <tr>
         <td width="25%" align="right" class="style1">关键字：</td>
