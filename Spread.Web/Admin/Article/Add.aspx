<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Spread.Web.Admin.Article.Add" ValidateRequest="false" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx?classId=<%=classId%>">返回列表</a></span><b>您当前的位置：首页 &gt; 公告管理 &gt; 发布公告</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tr>
            <th colspan="2" align="left">发布公告</th>
        </tr>
        <tr>
