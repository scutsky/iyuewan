<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Center.aspx.cs" Inherits="Spread.Web.Admin.admin_center" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
       ...
       <tr>
        ...
        <td>
          <%=webset.WebQQ1.ToString()%>
        </td>
      </tr>
       <tr>
        <td align="right">联系QQ2：</td>
        <td>
          <%=webset.WebQQ2.ToString()%>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <%=webset.SettlementCycle.ToString()%>
        </td>
      </tr>
        <tr>
        <td align="right">渠道上限：</td>
        <td>
          <%=webset.ChannelNum.ToString()%>
        </td>
      </tr>
      <tr>
