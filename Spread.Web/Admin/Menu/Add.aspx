<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Spread.Web.Admin.Menu.Add" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="list.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 平台分类管理 &gt; 增加平台分类</b>
    </div>
