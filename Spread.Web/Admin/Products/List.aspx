...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.Products.List" %>
...
<body style="padding:10px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="80%" align="right">关健字：</td>
        <td width="15%"><asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword"></asp:TextBox></td>
        <td width="5%" align="center"><asp:Button ID="btnSelect" runat="server" Text="查询" 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td>
          ...
          <asp:ImageButton ID="IsLock" CommandName="ibtnLock" runat="server" ImageUrl='<%# Convert.ToInt32(Eval("IsLock")) == 1 ? "../Images/ico-5.png" : "../Images/ico-5_.png"%>' ToolTip='<%# Convert.ToInt32(Eval("IsLock")) == 1 ? "取消关闭" : "设置关闭"%>' />
        </td>
        <td align="center"><span><a href="edit.aspx?id=<%#Eval("Id") %>&classId=<%=classId %>">修改</a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
