<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="Admin_config.aspx.cs" Inherits="Spread.Web.Admin.Config.admin_config" %>
...
<tbody>
  ...
  <tr>
   ...
   <tr>
    <td align="right">联系QQ1：</td>
    <td><asp:TextBox ID="txtWebQQ1" runat="server" CssClass="input" size="25" 
            maxlength="50" HintTitle="联系QQ1" HintInfo="格式如：22228888。"></asp:TextBox></td>
  </tr>
   <tr>
    <td align="right">联系QQ2：</td>
    <td><asp:TextBox ID="txtWebQQ2" runat="server" CssClass="input" size="25" 
            maxlength="50" HintTitle="联系QQ2" HintInfo="格式如：22228888。"></asp:TextBox></td>
  </tr>
  <tr>
    <td align="right">结算周期：</td>
    <td><asp:TextBox ID="txtSettlementCycle" runat="server" CssClass="input" size="25" 
            maxlength="50" HintTitle="结算周期" HintInfo="格式如：1"></asp:TextBox></td>
  </tr>
  <tr>
    <td align="right">渠道上限：</td>
    <td><asp:TextBox ID="txtChannelNum" runat="server" CssClass="input" size="25" 
            maxlength="50" HintTitle="渠道上限" HintInfo="格式如：1"></asp:TextBox></td>
  </tr>
  <tr>
...
<tbody>
  <tr>
    <th colspan="2" align="left"><strong>关键字参数设置</strong></th>
  </tr>
  <tr>
    <td width="25%" align="right">文章模型链接地址：</td>
    <td width="75%">
        <asp:TextBox ID="txtArtModelUrl" runat="server" CssClass="input required" size="50" 
            maxlength="255" HintTitle="文章模型链接地址" HintInfo="文章模型链接地址，用于建立文章类型的内链，如：“NewShow.aspx?ID”。"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <td width="25%" align="right">产品模型链接地址：</td>
    <td width="75%">
        <asp:TextBox ID="txtProModelUrl" runat="server" CssClass="input required" size="50" 
            maxlength="255" HintTitle="产品模型链接地址" HintInfo="产品模型链接地址，用于建立产品类型的内链，如：“ProductShow.aspx?ID”。"></asp:TextBox>
    </td>
  </tr>
  <tr>
    <td width="25%" align="right">下载模型链接地址：</td>
    <td width="75%">
        <asp:TextBox ID="txtDownModelUrl" runat="server" CssClass="input required" size="50" 
            maxlength="255" HintTitle="下载模型链接地址" HintInfo="下载模型链接地址，用于建立下载类型的内链，如：“DownloadShow.aspx?ID”。"></asp:TextBox>
    </td>
  </tr>
</tbody>
</table>
