...
namespace Spread.Web.Admin.Links
{
    public partial class Edit : Spread.Web.UI.ManagePage
    {
        ...
        {
            Spread.BLL.Links bll = new Spread.BLL.Links();
            Spread.Model.Links model = bll.GetModel(_id);
        ...
        {
            Spread.BLL.Links bll = new Spread.BLL.Links();
            Spread.Model.Links model = bll.GetModel(this.Id);
