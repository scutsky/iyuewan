<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddGoods.aspx.cs" Inherits="Spread.Web.Admin.Directory.AddGoods" %>
...
<body style="padding:10px;">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            maxlength="250" minlength="3" HintTitle="发布的应用标题" HintInfo="控制在100个字数内，标题文本尽量不要太长。"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            maxlength="100" HintTitle="应用简介" HintInfo="控制在50个字数内，如“产品简介”。"></asp:TextBox>
            
            </td>
        </tr>
         <tr>
            <td width="15%" align="right">内部编码：</td>
            <td width="85%">
