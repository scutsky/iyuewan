<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Spread.Web.Admin.Directory.Add" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="list.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 应用分类管理 &gt; 增加应用分类</b>
    </div>
    <div style="padding-bottom:10px;"></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th colspan="2" align="left">添加应用分类信息</th>
      </tr>
      <tr>
      ...
      <tr>
        <td width="25%" align="right">应用分类名称：</td>
        <td width="75%">
          <asp:TextBox ID="txtTitle" runat="server" CssClass="input required" size="30" 
            maxlength="50" HintTitle="应用分类名称" HintInfo="请填写该应用分类的名称，至少1个字符，小于50个字符。"></asp:TextBox>
        </td>
       </tr>
       <tr>
