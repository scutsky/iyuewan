...
{
    public partial class Pgamelist : Spread.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect("PgameList.aspx?" + this.CombUrlTxt(this.classId, this.keywords, this.property) + "page=0");
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            JscriptPrint("批量删除成功啦！", "PgameList.aspx" + CombUrlTxt(this.classId, this.keywords, this.property) + "page=0", "Success");
        }
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                JscriptPrint("导入成功啦！", "PgameList.aspx?" + CombUrlTxt(this.classId, this.keywords, this.property) + "page=0", "Success");
            }
        }
        ...
        private void DataSetOperator(DataSet ds, string filePath)
        {
            ...
            try
            {
                ...
                Spread.BLL.Pgame bllGame = new BLL.Pgame();
                bllGame.DeletByPlatform(strPlatform);
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    k++;
                    string sqlStr1 = "insert into Pgame(Name,Platform,FirstLetter,UpdateDate,IsLock)";
