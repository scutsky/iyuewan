<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.Goods.List" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation"><span class="add"><a href="Add.aspx">发布热门游戏</a></span><b>您当前的位置：首页 &gt; 热门游戏管理 &gt; 热门游戏列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="150" align="right">关健字：</td>
        <td width="200"><asp:TextBox ID="txtKeywords" runat="server" CssClass="keyword"></asp:TextBox></td>
