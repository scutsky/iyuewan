...
namespace Spread.Web.Admin.Catalog
{
    public partial class List : ManagePage
    {
        ...
        private void BindData()
        {
            ...
            DataTable dt = bll.GetList(0, string.Format(" ParentId={0} ", pid), "ClassOrder").Tables[0];

            this.rptClassList.DataSource = dt;
            this.rptClassList.DataBind();

            GetProductCatalog(pid);
        }
        ...
        protected void rptClassList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName.ToLower())
            {
                case "btndel":
                    ...
                    break;
                case "ibtnshow":
                    Spread.Model.Catalog model = bll.GetModel(id);
                    ...
                    break;
                case "ibtnmenu":
                    Spread.Model.Catalog model1 = bll.GetModel(id);
                    ...
                    break;
                case "ibtnlock":
                    Spread.Model.Catalog model2 = bll.GetModel(id);
        ...
        /// 分类路径
        /// </summary>
        protected DataTable CatalogPath
        {
            get;
            set;
        }
