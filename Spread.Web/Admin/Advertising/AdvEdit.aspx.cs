...
{
    public partial class AdvEdit : Spread.Web.UI.ManagePage
    {
        public int Id;
        ...
        private void ShowInfo(int editID)
        {
            ...
            Spread.Model.Advertising model = bll.GetModel(editID);
        ...
        {
            Spread.BLL.Advertising bll = new Spread.BLL.Advertising();
            Spread.Model.Advertising model = bll.GetModel(this.Id);
