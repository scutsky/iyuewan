<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardAdd.aspx.cs" Inherits="Spread.Web.Admin.Channel.CardAdd" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="GameCardList.aspx?id=<%=id %>">返回列表</a></span><b>您当前的位置：首页 &gt; 类别管理 &gt; 增加类别</b>
    </div>
