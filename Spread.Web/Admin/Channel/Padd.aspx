<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Padd.aspx.cs" Inherits="Spread.Web.Admin.Channel.Padd" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="Plist.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 平台渠道管理 &gt; 增加平台渠道</b>
    </div>
