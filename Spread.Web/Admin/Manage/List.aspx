<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.Manage.list" %>
        ...
        <div>
            ...
            <ItemTemplate>
              <tr>
                ...
                <td align="center">
                  <%#Eval("isLock").ToString().Trim() == "False" ? "<img title=\"正常\" src=\"../images/correct.gif\" />" : "<img title=\"禁用\" src=\"../images/disable.gif\" />"%>
                </td>
