<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Spread.Web.Admin.means.Add" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation">
      <span class="back"><a href="List.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 资料下载管理 &gt; 发布资料下载</b>
    </div>
