<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.means.List" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation"><span class="add"><a href="Add.aspx">发布产品</a></span><b>您当前的位置：首页 &gt; 下载资料管理 &gt; 资料列表</b></div>
      ...
      <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlClassId" runat="server" CssClass="select" 
                ...
                <asp:ListItem Value="3">宣传手册</asp:ListItem>
                <asp:ListItem Value="4">海报</asp:ListItem>
                </asp:DropDownList>&nbsp;
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td align="center"><%#GetMenuTitle(Convert.ToInt32(Eval("ClassId")))%></td>
