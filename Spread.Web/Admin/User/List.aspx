<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Spread.Web.Admin.User.List" %>
...
<body style="padding:10px;">
    ...
    <div class="navigation"><b>您当前的位置：首页 &gt; 账号管理 &gt; 账号列表</b></div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      ...
      <tr>
        ...
        <td><a href="Detail.aspx?id=<%#Eval("Id") %>"><%#Eval("Name")%></a></td>
        ...
        <td align="center"><span><a href="Detail.aspx?id=<%#Eval("Id") %>&classId=<%=UserType %>">查看</a></span></td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
      </table>
