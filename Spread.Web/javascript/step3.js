define("/public/javascripts/dist/app/index/forgetPwd/step3", [ "../../../common/validator", "../../../common/utils", "../../../common/alert-window", "../../../common/title-window", "../../../common/base-window" ], function(require) {
    ...
    var app = {
        ...
        _initValidate: function() {
            var that = this, validateParams, confirmPasswordName = $("#confirm-password").attr("name");
            validateParams = {
                ignore: "",
                rules: {},
                    ...
                    $.ajax({
                        ...
                        success: function(jsonData) {
                            if (jsonData.state.code === 2e6) {
                                window.location.href = "http://gm.hzjiulian.com/modPwdSuccess?token=" + jsonData.state.message;
                            } else {
            ...
            validateParams.rules[confirmPasswordName] = {
                equalTo: "#password"
            };
            this.validator = $("#form").validate(validateParams);
        }
    };
    app._init();
});
