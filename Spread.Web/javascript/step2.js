define("/public/javascripts/dist/app/index/forgetPwd/step2", [ "../../../common/validator", "../../../common/utils", "../../../common/alert-window", "../../../common/title-window", "../../../common/base-window" ], function(require) {
    ...
    var app = {
        ...
        _initValidate: function() {
            var that = this, validateParams, phoneName = $("#telphone").attr("name");
            validateParams = {
                ignore: "",
                rules: {},
                    ...
                    $.ajax({
                        ...
                        success: function(jsonData) {
                            if (jsonData.state.code === 2e6) {
                                window.location.href = "step3Page-token=.htm"/*tpa=http://gm.hzjiulian.com/step3Page?token=*/ + jsonData.state.message;
                            } else {
            ...
            validateParams.rules[phoneName] = {
                phoneNumber: true
            };
