...
namespace Spread.BLL
{
    ...
    public class Report
    {
        private readonly DAL.Report dal = new DAL.Report();
        public Report()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Report> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Model.Report> DataTableToList(DataTable dt)
        {
            List<Model.Report> modelList = new List<Model.Report>();
        ...
        {
            return dal.GetSumListZT(strWhere);
        }
